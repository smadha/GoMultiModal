...
plot_box(data_to_plot, "max-elongation",["class 1","class -1"])
 
plot_xy_histogram(class1_feature,class_1_feature, "max-elongation",["class1-","class-1-"])
